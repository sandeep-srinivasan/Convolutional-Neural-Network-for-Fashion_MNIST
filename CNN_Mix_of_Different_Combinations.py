...
#System with different layer sizes, different number of feature maps and different kernel size
...
class Network(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(in_features=5*5*64, out_features=120)
